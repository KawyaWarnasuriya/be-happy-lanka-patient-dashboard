...
@Component({
  selector: 'app-doctor4',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './doctor4.component.html',
  styleUrl: './doctor4.component.css'
})

export class Doctor4Component implements OnInit, OnDestroy {

  slides = [
    {
      heading: 'Personal Information',
      content: [
        { label: 'Full Name', value: 'Dr. Juliya' },
        { label: 'Age', value: '27' },
        { label: 'Gender', value: 'Female' },
        { label: 'Email', value: 'juliyafrank@gmail.com' },
