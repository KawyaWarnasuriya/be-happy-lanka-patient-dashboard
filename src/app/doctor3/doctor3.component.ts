...
@Component({
  selector: 'app-doctor3',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './doctor3.component.html',
  styleUrl: './doctor3.component.css'
})
export class Doctor3Component implements OnInit, OnDestroy {
  ...
  slides = [
    {
      ...
      content: [
        ...
        { label: 'Email', value: 'John34567@gmail.com' },
